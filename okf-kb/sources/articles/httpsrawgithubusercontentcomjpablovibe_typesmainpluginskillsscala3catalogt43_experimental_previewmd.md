---
type: Article
title: https://raw.githubusercontent.com/jpablo/vibe-types/main/plugin/skills/scala3/catalog/T43-experimental-preview.md
resource: https://raw.githubusercontent.com/jpablo/vibe-types/main/plugin/skills/scala3/catalog/T43-experimental-preview.md
timestamp: '2026-06-24T12:02:57Z'
---
...
2. \*\*`into` subclasses.\*\* Subclasses of an `into`-declared type are \_not\_ automatically valid conversion targets. If `class C extends T` and `T` is `into`, parameters of type `C` still require a language import for conversions.
