---
type: Article
title: https://raw.githubusercontent.com/jpablo/vibe-types/main/plugin/skills/scala3/catalog/T44-changed-dropped.md
resource: https://raw.githubusercontent.com/jpablo/vibe-types/main/plugin/skills/scala3/catalog/T44-changed-dropped.md
timestamp: '2026-06-24T12:02:58Z'
---
...
- \*\*Given disambiguation (rule 9).\*\* From Scala 3.5, when multiple givens match an expected type, the \_most general\_ one is preferred (not the most specific, as in overloading resolution). Compile with `-source:3.5-migration` to see warnings where behavior changes.
